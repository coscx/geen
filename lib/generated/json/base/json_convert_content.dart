...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case TimeLineModelEntity:
			...
			return timeLineModelDataTimeLineMyFromJson(data as TimeLineModelDataTimeLineMy, json) as T;    }
    return data as T;
  }
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case TimeLineModelEntity:
			...
			return timeLineModelDataTimeLineMyToJson(data as TimeLineModelDataTimeLineMy);    }
    return data as T;
  }
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'TimeLineModelEntity':
			...
			return TimeLineModelDataTimeLineMy().fromJson(json);    }
    return null;
  }
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'TimeLineModelEntity':
			...
			return List<TimeLineModelDataTimeLineMy>();    }
    return null;
  }
